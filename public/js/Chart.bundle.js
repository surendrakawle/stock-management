...
/***/ "./resources/plugins/chartjs/Chart.bundle.js":
/*!***************************************************!*\
  !*** ./resources/plugins/chartjs/Chart.bundle.js ***!
  \***************************************************/
...
(function (f) {
  ...
  return function e(t, n, r) {
    ...
    6: [function (require, module, exports) {
      ...
      (function (global, factory) {
        ...
        function Moment(config) {
          ...
          this._d = new Date(config._d != null ? config._d.getTime() : NaN); // Prevent infinite loop in case updateOffset creates new moment
          // objects.
        ...
        function defineLocale(name, config) {
          if (config !== null) {
            ...
            locales[name] = new Locale(mergeConfigs(parentConfig, config)); // backwards compat for now: also set the locale
        ...
        function cloneWithOffset(input, model) {
          ...
          if (model._isUTC) {
            res = model.clone();
            diff = (isMoment(input) || isDate(input) ? input.valueOf() : local__createLocal(input).valueOf()) - res.valueOf(); // Use low-level api, because this fn is low-level api.
        ...
        momentPrototype__proto.creationData = creationData; // Year
        ...
        prototype__proto.monthsShortRegex = monthsShortRegex; // Week
        ...
        prototype__proto.weekdaysMinRegex = weekdaysMinRegex; // Hours
    ...
    7: [function (require, module, exports) {
      ...
      require(44)(Chart); // Controllers must be loaded after elements
      ...
      module.exports = function (Chart) {
        ...
        Chart.controllers.bar = Chart.DatasetController.extend({
          ...
          initialize: function initialize(chart, datasetIndex) {
            Chart.DatasetController.prototype.initialize.call(this, chart, datasetIndex); // Use this to indicate that this is a bar dataset.
            ...
            helpers.extend(rectangle, {
              ...
              draw: function draw() {
                ...
                var halfHeight = vm.height / 2,
                    ...
                    halfStroke = vm.borderWidth / 2; // Canvas doesn't allow us to stroke inside the width so we can
                ...
                ctx.lineWidth = vm.borderWidth; // Corner points, from bottom-left to bottom-right clockwise
                // | 1 2 |
                // | 0 3 |
      ...
      module.exports = function (Chart) {
        ...
        Chart.controllers.line = Chart.DatasetController.extend({
          ...
          addElementAndReset: function addElementAndReset(index) {
            ...
            var meta = me.getMeta();
            Chart.DatasetController.prototype.addElementAndReset.call(me, index); // Make sure bezier control points are updated
          ...
          updateElement: function updateElement(point, index, reset) {
            ...
            x = xScale.getPixelForValue(_typeof(value) === 'object' ? value : NaN, index, datasetIndex, me.chart.isCombo);
          ...
          updateBezierControlPoints: function updateBezierControlPoints() {
            var me = this;
            var meta = me.getMeta();
            var area = me.chart.chartArea; // only consider points that are drawn in case the spanGaps option is ued
    ...
    20: [function (require, module, exports) {
      ...
      module.exports = function (Chart) {
        ...
        Chart.controllers.radar = Chart.DatasetController.extend({
          ...
          linkScales: helpers.noop,
          addElementAndReset: function addElementAndReset(index) {
            Chart.DatasetController.prototype.addElementAndReset.call(this, index); // Make sure bezier control points are updated
    ...
    23: [function (require, module, exports) {
      ...
      module.exports = function (Chart) {
        var helpers = Chart.helpers; //Create a dictionary of chart types, to allow for extension of existing types
        ...
        /** @lends Chart.Controller */
        {
          initialize: function initialize() {
            ...
            me.bindEvents(); // Make sure controllers are built first so that each dataset is bound to an axis before the scales
            // are built
            ...
            me.resetElements();
            me.initToolTip();
            me.update(); // After init plugin notification
          ...
          resize: function resize(silent) {
            ...
            helpers.retinaScale(chart); // Notify any plugins about the resize

            var newSize = {
              width: newWidth,
              height: newHeight
            };
            Chart.plugins.notify('resize', [me, newSize]); // Notify of resize
          ...
          update: function update(animationDuration, lazy) {
            var me = this;
            Chart.plugins.notify('beforeUpdate', [me]); // In case the entire data object changed
            ...
            Chart.layoutService.update(me, me.chart.width, me.chart.height); // Apply changes to the dataets that require the scales to have been calculated i.e BorderColor chages
          ...
          draw: function draw(ease) {
            ...
            var easingDecimal = ease || 1;
            me.clear();
            Chart.plugins.notify('beforeDraw', [me, easingDecimal]); // Draw all the scales
            ...
            Chart.plugins.notify('beforeDatasetsDraw', [me, easingDecimal]); // Draw each dataset via its respective controller (reversed to support proper line stacking)
            ...
            Chart.plugins.notify('afterDatasetsDraw', [me, easingDecimal]); // Finally draw the tooltip
          ...
          destroy: function destroy() {
            ...
            helpers.removeResizeListener(me.chart.canvas.parentNode); // Reset canvas height/width attributes

            var canvas = me.chart.canvas;
            canvas.width = me.chart.width;
            canvas.height = me.chart.height; // if we scaled the canvas in response to a devicePixelRatio !== 1, we need to undo that transform here
          ...
          eventHandler: function eventHandler(e) {
            ...
            me.lastTooltipActive = me.lastTooltipActive || []; // Find Active Elements for hover and tooltips
    ...
    24: [function (require, module, exports) {
      ...
      module.exports = function (Chart) {
        var helpers = Chart.helpers;
        var noop = helpers.noop; // Base class for all dataset controllers (line, bar, etc)
        ...
        helpers.extend(Chart.DatasetController.prototype, {
          ...
          buildOrUpdateElements: function buildOrUpdateElements() {
            ...
            var meta = this.getMeta(),
                ...
                numMetaData = md.length; // Make sure that we handle number of datapoints changing
    ...
    26: [function (require, module, exports) {
      ...
      module.exports = function (Chart) {
              ...
              if (key === 'scales') {
                ...
                helpers.each(value, function (valueObj, index) {
                  if (index < baseArray.length) {
                    if (_typeof(baseArray[index]) === 'object' && baseArray[index] !== null && _typeof(valueObj) === 'object' && valueObj !== null) {
        ...
        helpers.addResizeListener = function (node, callback) {
          ...
          style.right = 0;
          style.top = 0;
          style.bottom = 0; // Insert the iframe so that contentWindow is available
        ...
        helpers.removeResizeListener = function (node) {
          var hiddenIframe = node.querySelector('.chartjs-hidden-iframe'); // Remove the resize detect iframe
    ...
    27: [function (require, module, exports) {
      ...
      module.exports = function () {
        ...
        var Chart = function Chart(context, config) {
          ...
          context.canvas.style.display = context.canvas.style.display || 'block'; // Figure out what the size of the chart will be.
          ...
          me.originalCanvasStyleHeight = context.canvas.style.height; // High pixel density displays - multiply the size of the canvas height/width by the device pixel ratio, then scale.

          helpers.retinaScale(me);
          me.controller = new Chart.Controller(me); // Always bind this so that if the responsive state changes we still work
      ...
      module.exports = function (Chart) {
        ...
        Chart.layoutService = {
          ...
          update: function update(chartInstance, width, height) {
            ...
            var totalBottomBoxesHeight = yPadding; // Update, and calculate the left and right margins for the horizontal boxes
      ...
      module.exports = function (Chart) {
        ...
        Chart.Scale = Chart.Element.extend({
          ...
          calculateTickRotation: function calculateTickRotation() {
            ...
            var optionTicks = me.options.ticks; //Get the width of each grid by calculating the difference
            ...
            if (me.options.display) {
              if (me.isHorizontal()) {
                ...
                while (labelWidth > tickWidth && me.labelRotation < optionTicks.maxRotation) {
                  ...
                  firstRotated = cosRotation * firstWidth; // We're right aligning the text now.
          ...
          fit: function fit() {
            ...
            if (tickOpts.display && display) {
              ...
              if (isHorizontal) {
                ...
                var lastLabelWidth = me.ctx.measureText(me.ticks[me.ticks.length - 1]).width; // Ensure that our ticks are always inside the canvas. When rotated, ticks are right aligned which means that the right padding is dominated
                // by the font height
      ...
      module.exports = function (Chart) {
        ...
        Chart.Title = Chart.Element.extend({
          initialize: function initialize(config) {
            ...
            me.options = helpers.configMerge(Chart.defaults.global.title, config.options); // Contains hit boxes for each dataset (in dataset order)
      ...
      module.exports = function (Chart) {
        ...
        Chart.Tooltip = Chart.Element.extend({
          ...
          getTooltipSize: function getTooltipSize(vm) {
            ...
            helpers.each(vm.title, maxLineWidth); // Body width

            ctx.font = helpers.fontString(bodyFontSize, vm._bodyFontStyle, vm._bodyFontFamily);
            helpers.each(vm.beforeBody.concat(vm.afterBody), maxLineWidth); // Body lines may include some extra width due to the color box
            ...
            helpers.each(vm.footer, maxLineWidth); // Add padding
          ...
          determineAlignment: function determineAlignment(size) {
            ...
            if (lf(model.x)) {
              model.xAlign = 'left'; // Is tooltip too wide and goes over the right side of the chart.?
              ...
              model.xAlign = 'right'; // Is tooltip too wide and goes outside left edge of canvas?
          ...
          draw: function draw() {
            ...
            function lineToPoint(previousPoint, point) {
              ...
              if (point._view.steppedLine === true) {
                ...
                ctx.bezierCurveTo(previousPoint._view.controlPointNextX, previousPoint._view.controlPointNextY, vm.controlPointPreviousX, vm.controlPointPreviousY, vm.x, vm.y);
              }
            }
      ...
      module.exports = function (Chart) {
        ...
        var DatasetScale = Chart.Scale.extend({
          ...
          */
          ...
          getLabelForIndex: function getLabelForIndex(index) {
      ...
      module.exports = function (Chart) {
        ...
        var LinearRadialScale = Chart.LinearScaleBase.extend({
          ...
          fit: function fit() {
            ...
            var pointLabeFont = helpers.fontString(pointLabelFontSize, pointLabeFontStyle, pointLabeFontFamily); // Get maximum radius of the polygon. Either half the height (minus the text width) or half the width.
            ...
            for (i = 0; i < this.getValueCount(); i++) {
              ...
              textWidth = this.ctx.measureText(this.pointLabels[i] ? this.pointLabels[i] : '').width + 5; // Add quarter circle to make degree 0 mean top of circle
          ...
          setCenterPoint: function setCenterPoint(leftMovement, rightMovement) {
            ...
            me.xCenter = Math.round((maxLeft + maxRight) / 2 + me.left); // Always vertically in the centre as the text height doesn't change
          ...
          draw: function draw() {
            ...
            if (opts.display) {
              ...
              if (!opts.lineArc) {
                ...
                var outerDistance = me.getDistanceFromCenterForValue(opts.reverse ? me.min : me.max); // Point Label Font
                ...
                for (var i = me.getValueCount() - 1; i >= 0; i--) {
                  ...
                  var pointLabels = me.pointLabels; // Add quarter circle to make degree 0 mean top of circle
      ...
      module.exports = function (Chart) {
        ...
        var TimeScale = Chart.Scale.extend({
          ...
          buildTicks: function buildTicks() {
            ...
            }, me); // Tick displayFormat override
...
/***/ 8:
/*!*********************************************************!*\
  !*** multi ./resources/plugins/chartjs/Chart.bundle.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\stock-management\resources\plugins\chartjs\Chart.bundle.js */"./resources/plugins/chartjs/Chart.bundle.js");
